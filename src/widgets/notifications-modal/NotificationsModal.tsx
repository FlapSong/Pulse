...
const DEV_NEWS: DevNewsItem[] = [
  {
    id: 'news-2.1.0',
    version: 'v2.1',
    title: 'Апдейт Pulse HQ v2.1',
    date: '26 июля 2026',
    tag: 'Апдейт',
    description: 'Основные изменения за 24–26 июля.',
    points: [
      '🚀 Реализована полноценная очистка истории чата с синхронизацией.',
      '✨ Обновлен и оптимизирован экран загрузки приложения.',
      '🛠️ Улучшена стабильность работы приложения на хостинге.',
      '📈 Версия приложения повышена до 2.1.'
    ]
  },
  {
    id: 'news-2.0.0',
