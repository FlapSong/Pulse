...
export const VoiceDock: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-4 left-20 z-10 w-60 bg-[#111113]/95 border border-emerald-500/30 backdrop-blur-xl rounded-2xl shadow-[0_8px_32px_rgba(0,0,0,0.5)] p-3 flex flex-col gap-2.5 select-none animate-in fade-in slide-in-from-bottom-4 duration-300">
