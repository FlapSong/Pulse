...
const target = `          <div className="flex items-center gap-2 bg-[#111113] border border-white/[0.06] focus-within:border-[#22D3EE] rounded-2xl pl-3 pr-2 py-1.5 transition-all">
            <input
              type="file"
              ref={dmFileInputRef}
              className="hidden"
...
const replacement = `          {hasBlockedMe ? (
